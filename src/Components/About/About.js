...
const About = () => {
    return (
        <div className="m-20">
            <h1 className="m-20 text-zinc-600 text-4xl font-bold">About Us</h1>
            <div className="container flex m-40">

                <div className="w-full">
                    <img src="https://i.ibb.co/VDNC8WF/muscular-sportsman-training-arms-with-dumbbell-7502-4782.jpg" alt="" />
                </div>
                <div className="m-10">
