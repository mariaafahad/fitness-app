                ...
                <div className="py-12 px-10 w-1/4">
                    <div className="flex space-2 items-center border-b-2 pb-4">
                        ...
                        <div className="ml-3">
                            ...
                            <p className="text-center text-sm text-gray-600 mt-1 font-serif">DASHBOARD</p>
                        </div>
                    </div>
                    ...
                    <div className="flex mt-20 space-x-4 items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-400 hover:text-indigo-600 transition duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="bg-indigo-50 flex-grow py-12 px-10">
                    <div className="flex justify-between">
                        <div className="center">
                            ...
                            <h1 className="text-4xl font-bold text-gray-800 mt-">Welcome to FITNESS!!</h1>
                        </div>
                        <div>
