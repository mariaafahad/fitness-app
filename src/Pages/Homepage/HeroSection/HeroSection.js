      ...
      >
        <div className="text-white container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-3/5 justify-center items-start text-center md:text-left">
            <h1 className="my-4 text-4xl font-bold leading-tight text-green-400">
              THE BEST FITNESS STUDIO IN TOWN
            </h1>
            <p className="leading-normal text-xl my-8 text-yellow-100">
            ...
            <button className="mx-auto lg:mx-0 hover:underline uppercase bg-yellow-300 hover:bg-yellow-400 text-gray-800 font-bold rounded my-6 py-3 px-12 shadow-sm">
              Join Us
            </button>
          </div>
